...
class All():
    ...
    def all(self):
        ...
        #         # WebDriverWait(driver, 20).until(ec.element_to_be_clickable((By.XPATH, "//div[@class='css-1h1zoku']/div[1]//button"))).click()
        #
        #         # as new feature is arrived I am redirecting to onboarding//
        #         driver.get("https://test-talentplace.vercel.app/onboarding")
        #         time.sleep(3)
        # # In Dash Board
        #         # Click on Build Carrier Profile
        ...
        #           company = WebDriverWait(driver, 20).until(ec.element_to_be_clickable((By.XPATH, "//*[@class='custom-select__input']")))
        ...
        # #TODO: suggestion is not adding so comment
        #         # WebDriverWait(driver, 20).until(ec.element_to_be_clickable(
...
# """Projects"""
        ...
        WebDriverWait(driver, 20).until(ec.element_to_be_clickable((By.XPATH, "//button[@id='accordion-button-:rq:']"))).click()
        time.sleep(2)
