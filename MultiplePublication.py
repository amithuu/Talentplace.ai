...
class Publication():
    ...
    def publication(self):
        for i in range(3):
            ...
            # Publication Date
            publisher_date = WebDriverWait(driver, 20).until(
                ec.element_to_be_clickable((By.XPATH, "//*[@id='root']/div[2]/div[2]/div/div/div/div/div[2]/div/div/form/div/div[2]/div[1]//input")))
            ...
            time.sleep(3)
            # Author title
            # Todo: select is not working we need to do it..
